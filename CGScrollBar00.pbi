...
;}     
  ...
  Procedure   DrawLeft()
    ...
    StrokePath(Height * 0.05)
      
    ;Start Of Track;
    MovePathCursor(Height, Height * 0.5)
    AddPathLine(Height * 1.5, Height * 0.5)    
    StrokePath(2)
  StopVectorDrawing()
...
EndProcedure 
  ...
  Procedure   DrawTrack()
    ...
    Else
      VectorSourceColor(RGBA(255,0,0,255))
    EndIf   
    MovePathCursor(Height * 1.5 ,Height * 0.5)
    AddPathLine(Width - (Height * 1.5),Height * 0.5)
    StrokePath(2)
    StopVectorDrawing()
  ...
  Procedure   DrawRight()
    ...
    StartVectorDrawing(CanvasVectorOutput(MyGadgetArray(Currentgadget)\Gadget_ID))
      ...
      ;MainButton
      AddPathBox(Offset + Height,1,Height-2,Height-2)
      StrokePath(2)      

      ;Arrow
      MovePathCursor(Offset + (Height * 1.8), Height * 0.5)
      AddPathLine   (Offset + (Height * 1.2), Height * 0.5)
      MovePathCursor(Offset + (Height * 1.8), Height * 0.5)
      AddPathLine   (Offset + (Height * 1.3), Height * 0.2)     
      MovePathCursor(Offset + (Height * 1.8), Height * 0.5)
      AddPathLine   (Offset + (Height * 1.3), Height * 0.8)      
      StrokePath(Height * 0.05)
      
      ;Start Of Track
      MovePathCursor(Offset + Height, Height * 0.5)
      AddPathLine   (Offset + Height * 0.5, Height * 0.5) 
      StrokePath(2)
    StopVectorDrawing()
  ...
  Procedure DrawSlider(Value.d)
    ...
    StartVectorDrawing(CanvasVectorOutput(MyGadgetArray(Currentgadget)\Gadget_ID)) 
      ...
      MyGadgetArray(Currentgadget)\Slidercentre = Offset + (Height/2)
      MyGadgetArray(Currentgadget)\Ratio = (Width - (Height * 3))/100
      AddPathBox(Offset,0,Height,Height)
      FillPath()
